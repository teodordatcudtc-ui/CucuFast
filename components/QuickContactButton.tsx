        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="absolute bottom-full right-0 mb-4 space-y-3 w-max"
            >
              <a
                href="https://wa.me/407637838273?text=Salut%20Cucu%20Fast%20Service,%20as%20dori%20o%20programare."
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 bg-[#25D366] text-white px-5 py-3 rounded-full shadow-lg hover:bg-[#20BA5A] transition-colors"
              >
                <svg
                  width="24"
                  height="24"
              ...
              <a
                ...
                className="flex items-center gap-3 bg-primary text-white px-5 py-3 rounded-full shadow-lg hover:bg-primary-dark transition-colors"
              >
                <svg
                  width="24"
                  height="24"
